...
client.on('clickButton', async (button) => {
  ...
  const onybuton = new disbut.MessageButton()
    ...
    .setAuthor('EMRECONF', button.message.guild.iconURL({dynamic: true, type: 'gif', size: 1024}))
